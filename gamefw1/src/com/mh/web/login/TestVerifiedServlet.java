 ...
 */
public class TestVerifiedServlet extends HttpServlet {

	private static final long serialVersionUID = -34545L;

	public TestVerifiedServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			StringBuilder strb = new StringBuilder()
									...
									.append(random.nextInt(10))
									.append(random.nextInt(10));
			request.getSession().setAttribute(CommonConstant.TEST_VERITY_CODE_KEY, strb.toString());
