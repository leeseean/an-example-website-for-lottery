...
public class NewBBinInterfaceServiceImpl extends BaseFlatInfo implements FlatInterfaceService {
	...
	public String login(HttpServletRequest request) {
		try {
			...
			NBbinResResult result = NBBINIfcUtil.login(params);
			if (result != null) {
	...
	private String updateBbiAccountPonit(WebUser webUser,String flatName,String flatAccount,String optType,int points,int eduForward, String eduForwardRemark) throws RuntimeException{
