...
public class CpCacheUtil {
	...
	public static boolean isExistsOpenResults(String gameCode,String qs){
		String key=CpCommonConstant.CACHE_RESULT_CODE+gameCode.toLowerCase();
...
//			String qs =  String.valueOf(objArr[1]);
	...
	public static CpTomResults getTomCache(String gameCode,Date _date){
		...
		String key=CpCommonConstant.CACHE_TOM_CODE+gameCode.toLowerCase();
		if(MemCachedUtil.get(key)==null){
...
//			String qs = String.valueOf(objArr[1]);
			...
			if(_date.getTime()<gtKjsjDate.getTime()){
				...
				if(CpCommonConstant.HK_CODE_PARAM.equals(code) || CpCommonConstant.FC3D_CODE_PARAM.equals(code) || CpCommonConstant.PL3_CODE_PARAM.equals(code)){
					if(i>0){
						objArr=null;
					...
					objArr=null;
					if(CpCommonConstant.openPanMap.get(code)!=null){
