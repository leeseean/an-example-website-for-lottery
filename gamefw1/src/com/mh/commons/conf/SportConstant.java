/**   
* 文件名称: SportConstant.java<br/>
* 版本号: V1.0<br/>   
* 创建人: alex<br/>  
* 创建时间 : 2015-7-14 下午7:31:26<br/>
*/  
...
public class SportConstant {
	...
	public static Map<String, String> typeSportMap;
	static {
		typeSportMap = new LinkedHashMap<String, String>();
		typeSportMap.put("all", "所有体育");
		typeSportMap.put("ft", "足球");
		typeSportMap.put("bk", "篮球 / 美式足球");
		typeSportMap.put("tn", "网球");
		typeSportMap.put("vb", "排球");
		typeSportMap.put("bm", "羽毛球");
		typeSportMap.put("tt", "乒乓球");
		typeSportMap.put("bs", "棒球");
		typeSportMap.put("op", "其他");
	}
	...
	public static double FT_LIMIT_MIN = 10;//单注最小限额
	/**控制器状态**/
	public static int CURSTATUS_OK = 1;
	public static int SHOWSTATUS_OK = 1;
	
	/**足球串关容器**/
	public static Map<String, SportBet> ft_tom = new HashMap<String, SportBet>();
	public static Map<String, SportBet> ft_today = new HashMap<String, SportBet>();
	...
	public static final String CONTROL_KEY = "HG_V_";//版本号标识
