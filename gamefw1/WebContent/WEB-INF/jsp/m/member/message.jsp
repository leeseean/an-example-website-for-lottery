...
<body>
  <div data-role="page">
    <script type="text/javascript">
  	...
  	{
  		$.ajax( {
  			url : rootPath+"/m/message/delMessage",
  			type : "POST",
  			data : {id : id},
  			dataType : "json",
  			timeout:30000,
        ...
        <c:forEach items="${msgList }" var="item">
	        <li>
	          <div class="ui-grid-b">
	            ...
	            <div class="ui-block-c tac"><a href="javascript:void(0);" onclick="delMessage('${item.id}');">删除</a></div>
	          </div>
	        </li>
        </c:forEach>
        </c:when>
    ...
    <div data-role="footer" data-position="fixed" data-id="deposit-footer">
      <div data-role="navbar">
        <ul>
          <li><a href="${ctx }/m/message/getMessageList?code=2" data-transition="none" class="ui-btn-active ui-state-persist">个人信息</a></li>
          <li><a href="${ctx }/m/message/getMessageList?code=1" data-transition="none" >系统信息</a></li>
        </ul>
      </div>
    </div>
    <!-- /footer -->
