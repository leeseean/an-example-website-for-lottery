...
<body>
  <div data-role="page" id="deposit-accounts">
    ...
    <div data-role="footer" data-position="fixed" data-id="deposit-footer">
      <div data-role="navbar">
        <ul>
          <li><a href="#deposit-accounts" data-transition="none" class="ui-btn-active ui-state-persist">微信账户</a></li>
  ...
  <div data-role="page" id="deposit-form">
    ...
    <div data-role="content" class="ybm-deposit">
      <div class="ybm-form deposit-form ui-mini">
        <ul data-role="listview">
          ...
          <li>
            <div data-role="fieldcontain">
              <label for="hkUserName">支付凭证后4位验证码</label>
    ...
    <div data-role="footer" data-position="fixed" data-id="deposit-footer">
      <div data-role="navbar">
        <ul>
          <li><a href="#deposit-accounts" data-transition="none">微信账户</a></li>
  ...
  <div data-role="content" class="ybm-order-confirm">
    <ul data-role="listview">
      ...
      <li style=" text-align: center;">
          <fieldset data-role="controlgroup" data-type="horizontal" data-corners="false">
            <a href="${ctx }/m/member/gowxpay?paytype=1" data-ajax="false" data-role="button" data-icon="check" data-theme="b">确认</a>
          </fieldset>
      </li>
    </ul>
  </div>
...
function wx_submit()
{
	...
	$.ajax( {
		...
		type : "POST",
		data :{"hkMoney":hkMoney,"hkUserName":hkUserName,"createTime":createTime,"payType":1,"payNo":payNo},
		dataType : "json",
		timeout:30000,
