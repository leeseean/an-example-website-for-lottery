...
<script type="text/javascript">
		...
		var myLeg = new Array();
		var sportAction="${ctx}/sport/getBkResults";
				...
				<td class="mem">
					<h2>
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							...
							<tbody>
								<tr>
									<td id="page_no"><select name="selgtype" id="selgtype"
										onchange="chg_gtype(selgtype.value,'BK','${ctx}/sport/getBkResults?searchDate=${afterDate}')">
											<option value="BK" selected="">篮球 : 赛果</option>
									</select>
									</td>
									<td id="tool_td">
										...
										<table border="0" cellspacing="0" cellpadding="0"
											...
											<tbody>
												<tr>
													<td class="searh">
														<form name="game_result" action="${ctx}/sport/getBkResults"
															method="POST">
															<span class="rig"> <a
																href="${ctx}/sport/getBkResults?searchDate=${beforeDate }">昨日</a>
																&nbsp;&nbsp; <c:if test="${! empty afterDate }">/&nbsp;&nbsp;
																<a href="${ctx}/sport/getBkResults?searchDate=${afterDate}">明日</a>
