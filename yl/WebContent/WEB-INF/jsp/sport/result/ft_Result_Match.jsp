							...
							<tbody>
								<tr>
									<td id="page_no"><select name="selgtype" id="selgtype"
										onchange="chg_gtype(selgtype.value,'FT','&searchDate=${searchDate }')">
									...
									<td id="tool_td">
										...
										<table border="0" cellspacing="0" cellpadding="0"
											...
											<tbody>
												<tr>
													<td class="searh">
														<form name="game_result" action="${ctx }/sport/getftRes"
															method="POST">
															<span class="rig"><a
																href="${ctx }/sport/getftRes?searchDate=${beforeDate }">昨日</a>
