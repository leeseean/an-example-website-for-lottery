...
<body id="HFT" class="bodyset" >
	...
	<div id="mem_box">
	  ...
	  <c:choose>
		<c:when test="${!empty webUser}">
			<span class="his"><a href="javascript:chg_url('${ctx}/sport/accountHis');" target="body">帐户历史</a></span> | <span class="wag"><a href="javascript:chg_url('${ctx}/sport/accountOrder');" target="body">交易状况</a> </span>
		</c:when>
		<c:otherwise>
