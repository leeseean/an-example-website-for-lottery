...
<form name="xiazhuForm" id="xiazhuForm" onsubmit="javascritp:return orderSubmit(this.form);" action="${ctx}/sport/orderBet" method="post">
    <div class="ord">
        <div class="title">
        ...
        <div class="betBox">
            <input type="button" name="btnCancel" value="取消"  class="no"  onclick="cancelBetOrder()" />
            <span id="submit">
            	<input type="submit" name="submit" value="确定交易" class="yes">
            </span>
        </div>
    </div>
