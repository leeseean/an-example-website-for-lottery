					...
					<ul class="clear">
						...
						<li>
							<select name="flatName" id="flatName" class="dropmenu" style="width: 80px;">
								...
								<option value="ag" ${records.flatName=="ag"?"selected='selected'":"" }>
									AG
								</option>
								<option value="hg" ${records.flatName=="hg"?"selected='selected'":"" }>
									HG
								</option>
								<option value="mg" ${records.flatName=="mg"?"selected='selected'":"" }>
									MG
								</option>
								<option value="bbin" ${records.flatName=="bbin"?"selected='selected'":"" }>
									BBIN
								</option>
								<option value="ds" ${records.flatName=="ds"?"selected='selected'":"" }>
									DS
								</option>
								<option value="nt" ${records.flatName=="nt"?"selected='selected'":"" }>
									NT
								</option>
								<option value="pt" ${records.flatName=="pt"?"selected='selected'":"" }>
									PT
								</option>
							</select>
						</li>
