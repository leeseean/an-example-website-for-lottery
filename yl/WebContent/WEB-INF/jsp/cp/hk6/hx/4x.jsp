		...
		<table class="tab_001" border="0" cellSpacing="0" cellPadding="0"
			...
			<tbody>
				<tr style='background: url("${resourceRoot}/cp/images/title_bg_004.gif") repeat-x left top;'>
					<td><span class="font_sty001"><strong>四肖下注</strong> </span></td>
				...
				<tr class="hsetEm">
					...
					<tr class="hset">
						<td class="tbtitle4" colSpan="8">类型：<input id="glx"
							...
							name="glx" value="2" CHECKED="checked" type="radio"> 四肖&nbsp; <input
							id="glx"
							onclick="document.location='${ctx}/cp/goList?gameTypeCode=HK6&cpTypeCode=HX&cpZuTypeCode=6x'"
							name="glx" value="3" type="radio"> 六肖</td>
					</tr>

					<form name="order_form" id="order_form" onsubmit="return SubChk(this);" action="${ctx}/order/goMultiGroupOrderList?code=HK6&type=HX&cate=SX&multilen=4" method="post" target="bet_order_frame" autocomplete="off">
					<tr class="tbtitle2">
						<td>生肖</td>
						<td>赔率</td>
						<td>勾选</td>
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_953">2.88</font>
						</td>
						<td class="ball_ff"><input id="Num_953" name="Num_953" value="鼠"
							type="checkbox">
						</td>
						...
						<td class="ball_ff"><font id="bl_959">2.88</font>
						</td>
						<td class="ball_ff"><input id="Num_959" name="Num_959" value="牛"
							type="checkbox"></td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_954">2.88</font>
						</td>
						<td class="ball_ff"><input id="Num_954" name="Num_954" value="虎"
							type="checkbox">
						</td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
						...
						<td class="ball_ff"><font id="bl_960">2.88</font>
						</td>
						<td class="ball_ff"><input id="Num_960" name="Num_960" value="兔"
							type="checkbox"></td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_955">2.88</font>
						</td>
						<td class="ball_ff"><input id="Num_955" name="Num_955" value="龙"
							type="checkbox">
						</td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
						...
						<td class="ball_ff"><font id="bl_961">2.88</font>
						</td>
						<td class="ball_ff"><input id="Num_961" name="Num_961" value="蛇"
							type="checkbox"></td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_956">2.88</font>
						</td>
						<td class="ball_ff"><input id="Num_956" name="Num_956" value="马"
							type="checkbox">
						</td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
						...
						<td class="ball_ff"><font id="bl_962">2.75</font>
						</td>
						<td class="ball_ff"><input id="Num_962" name="Num_962" value="羊"
							type="checkbox"></td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_957">2.88</font>
						</td>
						<td class="ball_ff"><input id="Num_957" name="Num_957" value="猴"
							type="checkbox">
						</td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
						...
						<td class="ball_ff"><font id="bl_963">2.88</font>
						</td>
						<td class="ball_ff"><input id="Num_963" name="Num_963" value="鸡"
							type="checkbox"></td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_958">2.88</font>
						</td>
						<td class="ball_ff"><input id="Num_958" name="Num_958" value="狗"
							type="checkbox">
						</td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
						...
						<td class="ball_ff"><font id="bl_964">2.88</font>
						</td>
						<td class="ball_ff"><input id="Num_964" name="Num_964" value="猪"
							type="checkbox"></td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
