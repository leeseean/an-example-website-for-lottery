		...
		<table class="tab_001" border="0" cellSpacing="0" cellPadding="0"
			...
			<tbody>
				<tr style='background: url("${resourceRoot}/cp/images/title_bg_004.gif") repeat-x left top;'>
					<td><span class="font_sty001"><strong>六肖下注</strong> </span></td>
				...
				<tr class="hsetEm">
					...
					<tr class="hset">
						<td class="tbtitle4" colSpan="8">类型：<input id="glx"
							...
							name="glx" value="3" CHECKED="checked" type="radio"> 六肖</td>
					</tr>
					<form name="order_form" id="order_form" onsubmit="return SubChk(this);" action="${ctx}/order/goMultiGroupOrderList?code=HK6&type=HX&cate=LX&multilen=6" method="post" target="bet_order_frame" autocomplete="off">
					<tr class="tbtitle2">
						<td>生肖</td>
						<td>赔率</td>
						<td>勾选</td>
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_965">1.92</font>
						</td>
						<td class="ball_ff"><input id="Num_965" name="Num_965" value="鼠"
							type="checkbox">
						</td>
						...
						<td class="ball_ff"><font id="bl_971">1.92</font>
						</td>
						<td class="ball_ff"><input id="Num_971" name="Num_971" value="牛"
							type="checkbox"></td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_966">1.92</font>
						</td>
						<td class="ball_ff"><input id="Num_966" name="Num_966" value="虎"
							type="checkbox">
						</td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
						...
						<td class="ball_ff"><font id="bl_972">1.92</font>
						</td>
						<td class="ball_ff"><input id="Num_972" name="Num_972" value="兔"
							type="checkbox"></td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_967">1.92</font>
						</td>
						<td class="ball_ff"><input id="Num_967" name="Num_967" value="龙"
							type="checkbox">
						</td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
						...
						<td class="ball_ff"><font id="bl_973">1.92</font>
						</td>
						<td class="ball_ff"><input id="Num_973" name="Num_973" value="蛇"
							type="checkbox"></td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_968">1.92</font>
						</td>
						<td class="ball_ff"><input id="Num_968" name="Num_968" value="马"
							type="checkbox">
						</td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
						...
						<td class="ball_ff"><font id="bl_974">1.92</font>
						</td>
						<td class="ball_ff"><input id="Num_974" name="Num_974" value="羊"
							type="checkbox"></td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_969">1.92</font>
						</td>
						<td class="ball_ff"><input id="Num_969" name="Num_969" value="猴"
							type="checkbox">
						</td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
						...
						<td class="ball_ff"><font id="bl_975">1.92</font>
						</td>
						<td class="ball_ff"><input id="Num_975" name="Num_975" value="鸡"
							type="checkbox"></td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_970">1.92</font>
						</td>
						<td class="ball_ff"><input id="Num_970" name="Num_970" value="狗"
							type="checkbox">
						</td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
						...
						<td class="ball_ff"><font id="bl_976">1.92</font>
						</td>
						<td class="ball_ff"><input id="Num_976" name="Num_976" value="猪"
							type="checkbox"></td>
						<td style="white-space: nowrap;" class="ball_bg">
						<%
