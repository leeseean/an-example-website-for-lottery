				...
				<tbody>
					...
					<tr class="hset">
						<td class="tbtitle4" colSpan="8">类型：<input id="glx"
							...
							name="glx" value="4" CHECKED="checked" type="radio"> 四尾连&nbsp;</td>
					</tr>
					<form name="order_form" id="order_form" onsubmit="return SubChk(this);"
						action="${ctx}/order/goMultiGroupOrderList?code=HK6&type=WSL&cate=SIWL&multilen=4" method="post"
					...
					<tr class="tbtitle">
						...
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"name="Num_883" value="0" type="checkbox">
						</td>
						<td id="bl_883" class="ball_ff">18</td>
						<td style="white-space: nowrap;">&nbsp;10.20.30.40</td>

						<td class="ball_bg">5尾</td>
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"name="Num_888" value="5" type="checkbox">
						</td>
						<td id="bl_888" class="ball_ff">15</td>
						<td style="white-space: nowrap;">&nbsp;05.15.25.35.45</td>
					</tr>
					<tr class="tbtitle">
						<td class="ball_bg">1尾</td>
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"name="Num_884" value="1" type="checkbox">
						</td>
						<td id="bl_884" class="ball_ff">15</td>
						<td style="white-space: nowrap;">&nbsp;01.11.21.31.41</td>

						<td class="ball_bg">6尾</td>
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"name="Num_889" value="6" type="checkbox">
						</td>
						<td id="bl_889" class="ball_ff">15</td>
						<td style="white-space: nowrap;">&nbsp;06.16.26.36.46</td>
					</tr>
					<tr class="tbtitle">
						<td class="ball_bg">2尾</td>
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"	name="Num_885" value="2" type="checkbox">
						</td>
						<td id="bl_885" class="ball_ff">15</td>

						<td style="white-space: nowrap;">&nbsp;02.12.22.32.42</td>
						<td class="ball_bg">7尾</td>
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"name="Num_890" value="7" type="checkbox">
						</td>
						<td id="bl_890" class="ball_ff">15</td>
						<td style="white-space: nowrap;">&nbsp;07.17.27.37.47</td>
					</tr>
					<tr class="tbtitle">
						<td class="ball_bg">3尾</td>
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"	name="Num_886" value="3" type="checkbox">
						</td>
						<td id="bl_886" class="ball_ff">15</td>
						<td style="white-space: nowrap;">&nbsp;03.13.23.33.43</td>

						<td class="ball_bg">8尾</td>
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"name="Num_891" value="9" type="checkbox">
						</td>
						<td id="Num_891" class="ball_ff">15</td>
					...
					<tr class="tbtitle">
						...
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"	name="Num_887" value="4" type="checkbox">
						</td>
						<td id="bl_887" class="ball_ff">15</td>
						<td style="white-space: nowrap;">&nbsp;04.14.24.34.44</td>

						<td class="ball_bg">9尾</td>
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"name="Num_892" value="9" type="checkbox">
						</td>
						<td id="bl_892" class="ball_ff">15</td>
