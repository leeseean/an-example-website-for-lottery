		...
		<table class="tab_001" border="0" cellSpacing="0" cellPadding="0"
			...
			<tbody>
				<tr style='background: url("${resourceRoot}/cp/images/title_bg_004.gif") repeat-x left top;'>
					<td><span class="font_sty001"><strong>二尾连下注</strong> </span>
					</td>
			...
			<table class="game_table" border="0" cellSpacing="1" cellPadding="0">
				<tbody>
					...
					<form name="order_form" id="order_form" onsubmit="return SubChk(this);"
						action="${ctx}/order/goMultiGroupOrderList?code=HK6&type=WSL&cate=SAWL&multilen=3" method="post"
					...
					<tr class="tbtitle">
						...
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"name="Num_873" value="0" type="checkbox">
						</td>
						<td id="bl_873" class="ball_ff">7.5</td>

						<td style="white-space: nowrap;">&nbsp;10.20.30.40</td>
						<td class="ball_bg">5尾</td>
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"name="Num_878" value="5" type="checkbox">
						</td>
						<td id="bl_878" class="ball_ff">6.2</td>
						<td style="white-space: nowrap;">&nbsp;05.15.25.35.45</td>
					</tr>
					<tr class="tbtitle">
						<td class="ball_bg">1尾</td>
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"name="Num_874" value="1" type="checkbox">
						</td>
						<td id="bl_874" class="ball_ff">6.2</td>

						<td style="white-space: nowrap;">&nbsp;01.11.21.31.41</td>
						<td class="ball_bg">6尾</td>
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"name="Num_879" value="6" type="checkbox">
						</td>
						<td id="bl_879" class="ball_ff">6.2</td>
						<td style="white-space: nowrap;">&nbsp;06.16.26.36.46</td>
					</tr>
					<tr class="tbtitle">
						<td class="ball_bg">2尾</td>
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"	name="Num_875" value="2" type="checkbox">
						</td>
						<td id="bl_875" class="ball_ff">6.2</td>

						<td style="white-space: nowrap;">&nbsp;02.12.22.32.42</td>
						<td class="ball_bg">7尾</td>
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"name="Num_880" value="7" type="checkbox">
						</td>
						<td id="bl_880" class="ball_ff">6.2</td>
						<td style="white-space: nowrap;">&nbsp;07.17.27.37.47</td>
					</tr>
					<tr class="tbtitle">
						<td class="ball_bg">3尾</td>
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"	name="Num_876" value="3" type="checkbox">
						</td>
						<td id="bl_876" class="ball_ff">6.2</td>

						<td style="white-space: nowrap;">&nbsp;03.13.23.33.43</td>
						<td class="ball_bg">8尾</td>
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"	name="Num_881" value="8" type="checkbox">
						</td>
						<td id="bl_881" class="ball_ff">6.2</td>
						<td style="white-space: nowrap;">&nbsp;08.18.28.38.48</td>
					</tr>
					<tr class="tbtitle">
						<td class="ball_bg">4尾</td>
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"	name="Num_877" value="4" type="checkbox">
						</td>
						<td id="bl_877" class="ball_ff">6.2</td>
						<td style="white-space: nowrap;">&nbsp;04.14.24.34.44</td>
						<td class="ball_bg">9尾</td>
						<td class="ball_ff">
							<input onclick="return SubChkBox(this)"name="Num_882" value="9" type="checkbox">
						</td>
						<td id="bl_882" class="ball_ff">6.2</td>
