		...
		<table class="tab_001" border="0" cellSpacing="0" cellPadding="0"
			...
			<tbody>
				<tr style='background: url("${resourceRoot}/cp/images/title_bg_004.gif") repeat-x left top;'>
					<td><span class="font_sty001"><strong>五肖连[中]下注</strong> </span></td>
				...
				<tr class="hsetEm">
					...
					<tr class="hset">
						<td class="tbtitle4" colSpan="8">类型：<input id="glx"
							...
							name="glx" value="7" CHECKED="checked"  type="radio"> 五肖连[中]&nbsp;</td>
					</tr>
					<form name="order_form" id="order_form" onsubmit="return SubChk(this);" action="${ctx}/order/goMultiGroupOrderList?code=HK6&type=LX&cate=WLX&multilen=5" method="post" target="bet_order_frame" autocomplete="off">
					<tr class="tbtitle2">
						<td>生肖</td>
						<td>赔率</td>
						<td>勾选</td>
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_929">100</font>
						</td>
						<td class="ball_ff"><input id="sxsx61" name="sxsx61"
							value="0" type="hidden"> <input id="Num_929"
							onclick="return SubChkBox(this,1)" name="Num_929" value="鼠"
						...
						<td class="ball_ff"><font id="bl_935">100</font>
						</td>
						<td class="ball_ff"><input id="sxsx67" name="sxsx67"
							value="0" type="hidden"> <input id="Num_935"
							onclick="return SubChkBox(this,7)" name="Num_935" value="牛"
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_930">100</font>
						</td>
						<td class="ball_ff"><input id="sxsx62" name="sxsx62"
							value="0" type="hidden"> <input id="Num_930"
							onclick="return SubChkBox(this,2)" name="Num_930" value="虎"
						...
						<td class="ball_ff"><font id="bl_936">100</font>
						</td>
						<td class="ball_ff"><input id="sxsx68" name="sxsx68"
							value="0" type="hidden"> <input id="Num_936"
							onclick="return SubChkBox(this,8)" name="Num_936" value="兔"
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_931">100</font>
						</td>
						<td class="ball_ff"><input id="sxsx63" name="sxsx63"
							value="0" type="hidden"> <input id="Num_931"
							onclick="return SubChkBox(this,3)" name="Num_931" value="龙"
						...
						<td class="ball_ff"><font id="bl_937">100</font>
						</td>
						<td class="ball_ff"><input id="sxsx69" name="sxsx69"
							value="0" type="hidden"> <input id="Num_937"
							onclick="return SubChkBox(this,9)" name="Num_937" value="蛇"
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_932">100</font>
						</td>
						<td class="ball_ff"><input id="sxsx64" name="sxsx64"
							value="0" type="hidden"> <input id="Num_932"
							onclick="return SubChkBox(this,4)" name="Num_932" value="马"
						...
						<td class="ball_ff"><font id="bl_938">3.5</font>
						</td>
						<td class="ball_ff"><input id="sxsx610" name="sxsx610"
							value="0" type="hidden"> <input id="Num_938"
							onclick="return SubChkBox(this,10)" name="Num_938" value="羊"
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_933">100</font>
						</td>
						<td class="ball_ff"><input id="sxsx65" name="sxsx65"
							value="0" type="hidden"> <input id="Num_933"
							onclick="return SubChkBox(this,5)" name="Num_933" value="猴"
						...
						<td class="ball_ff"><font id="bl_939">100</font>
						</td>
						<td class="ball_ff"><input id="sxsx611" name="sxsx611"
							value="0" type="hidden"> <input id="Num_939"
							onclick="return SubChkBox(this,11)" name="Num_939" value="鸡"
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_934">100</font>
						</td>
						<td class="ball_ff"><input id="sxsx66" name="sxsx66"
							value="0" type="hidden"> <input id="Num_934"
							onclick="return SubChkBox(this,6)" name="Num_934" value="狗"
						...
						<td class="ball_ff"><font id="bl_940">100</font>
						</td>
						<td class="ball_ff"><input id="sxsx612" name="sxsx612"
							value="0" type="hidden"> <input id="Num_940"
							onclick="return SubChkBox(this,12)" name="Num_940" value="猪"
