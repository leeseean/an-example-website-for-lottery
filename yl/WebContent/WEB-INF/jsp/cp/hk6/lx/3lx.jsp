		...
		<table class="tab_001" border="0" cellSpacing="0" cellPadding="0"
			...
			<tbody>
				<tr style='background: url("${resourceRoot}/cp/images/title_bg_004.gif") repeat-x left top;'>
					<td><span class="font_sty001"><strong>三肖连[中]下注</strong> </span></td>
				...
				<tr class="hsetEm">
					...
					<tr class="hset">
						<td class="tbtitle4" colSpan="8">类型：<input id="glx"
							...
							name="glx" value="3" CHECKED="checked" type="radio"> 三肖连[中]&nbsp; <input
							id="glx"
					...
					<form name="order_form" id="order_form" onsubmit="return SubChk(this);" action="${ctx}/order/goMultiGroupOrderList?code=HK6&type=LX&cate=SALX&multilen=3" method="post" target="bet_order_frame" autocomplete="off">
					<tr class="tbtitle2">
						<td>生肖</td>
						<td>赔率</td>
						<td>勾选</td>
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_905">10.5</font>
						</td>
						<td class="ball_ff"><input id="sxsx61" name="sxsx61"
							value="0" type="hidden"> <input id="Num_905"
							onclick="return SubChkBox(this,1)" name="Num_905" value="鼠"
						...
						<td class="ball_ff"><font id="bl_911">10.5</font>
						</td>
						<td class="ball_ff"><input id="sxsx67" name="sxsx67"
							value="0" type="hidden"> <input id="Num_911"
							onclick="return SubChkBox(this,7)" name="Num_911" value="牛"
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_906">10.5</font>
						</td>
						<td class="ball_ff"><input id="sxsx62" name="sxsx62"
							value="0" type="hidden"> <input id="Num_906"
							onclick="return SubChkBox(this,2)" name="Num_906" value="虎"
						...
						<td class="ball_ff"><font id="bl_912">10.5</font>
						</td>
						<td class="ball_ff"><input id="sxsx68" name="sxsx68"
							value="0" type="hidden"> <input id="Num_912"
							onclick="return SubChkBox(this,8)" name="Num_912" value="兔"
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_907">10.5</font>
						</td>
						<td class="ball_ff"><input id="sxsx63" name="sxsx63"
							value="0" type="hidden"> <input id="Num_907"
							onclick="return SubChkBox(this,3)" name="Num_907" value="龙"
						...
						<td class="ball_ff"><font id="bl_913">10.5</font>
						</td>
						<td class="ball_ff"><input id="sxsx69" name="sxsx69"
							value="0" type="hidden"> <input id="Num_913"
							onclick="return SubChkBox(this,9)" name="Num_913" value="蛇"
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_908">10.5</font>
						</td>
						<td class="ball_ff"><input id="sxsx64" name="sxsx64"
							value="0" type="hidden"> <input id="Num_908"
							onclick="return SubChkBox(this,4)" name="Num_908" value="马"
						...
						<td class="ball_ff"><font id="bl_914">3.5</font>
						</td>
						<td class="ball_ff"><input id="sxsx610" name="sxsx610"
							value="0" type="hidden"> <input id="Num_914"
							onclick="return SubChkBox(this,10)" name="Num_914" value="羊"
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_909">10.5</font>
						</td>
						<td class="ball_ff"><input id="sxsx65" name="sxsx65"
							value="0" type="hidden"> <input id="Num_909"
							onclick="return SubChkBox(this,5)" name="Num_909" value="猴"
						...
						<td class="ball_ff"><font id="bl_915">10.5</font>
						</td>
						<td class="ball_ff"><input id="sxsx611" name="sxsx611"
							value="0" type="hidden"> <input id="Num_915"
							onclick="return SubChkBox(this,11)" name="Num_915" value="鸡"
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_910">10.5</font>
						</td>
						<td class="ball_ff"><input id="sxsx66" name="sxsx66"
							value="0" type="hidden"> <input id="Num_910"
							onclick="return SubChkBox(this,6)" name="Num_910" value="狗"
						...
						<td class="ball_ff"><font id="bl_916">10.5</font>
						</td>
						<td class="ball_ff"><input id="sxsx612" name="sxsx612"
							value="0" type="hidden"> <input id="Num_916"
							onclick="return SubChkBox(this,12)" name="Num_916" value="猪"
