		...
		<table class="game_table" border="0" cellSpacing="1" cellPadding="0">
			<tbody>
				...
				<tr class="hsetEm">
					...
					<form name="order_form" id="order_form" onsubmit="return SubChk(this);" action="${ctx}/order/goMultiGroupOrderList?code=HK6&type=LX&cate=ELX&multilen=2" method="post" target="bet_order_frame" autocomplete="off">
					<tr class="tbtitle2">
						<td>生肖</td>
						<td>赔率</td>
						<td>勾选</td>
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_893">4.2</font>
						</td>
						<td class="ball_ff"><input id="sxsx61" name="sxsx61"
							value="0" type="hidden"> <input id="Num_893"
							onclick="return SubChkBox(this,1)" name="Num_893" value="鼠"
						...
						<td class="ball_ff"><font id="bl_899">4.2</font>
						</td>
						<td class="ball_ff"><input id="sxsx67" name="sxsx67"
							value="0" type="hidden"> <input id="Num_899"
							onclick="return SubChkBox(this,7)" name="Num_899" value="牛"
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_894">4.2</font>
						</td>
						<td class="ball_ff"><input id="sxsx62" name="sxsx62"
							value="0" type="hidden"> <input id="Num_894"
							onclick="return SubChkBox(this,2)" name="Num_894" value="虎"
						...
						<td class="ball_ff"><font id="bl_900">4.2</font>
						</td>
						<td class="ball_ff"><input id="sxsx68" name="sxsx68"
							value="0" type="hidden"> <input id="Num_900"
							onclick="return SubChkBox(this,8)" name="Num_900" value="兔"
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_895">4.2</font>
						</td>
						<td class="ball_ff"><input id="sxsx63" name="sxsx63"
							value="0" type="hidden"> <input id="Num_895"
							onclick="return SubChkBox(this,3)" name="Num_895" value="龙"
						...
						<td class="ball_ff"><font id="bl_901">4.2</font>
						</td>
						<td class="ball_ff"><input id="sxsx69" name="sxsx69"
							value="0" type="hidden"> <input id="Num_901"
							onclick="return SubChkBox(this,9)" name="Num_901" value="蛇"
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_896">4.2</font>
						</td>
						<td class="ball_ff"><input id="sxsx64" name="sxsx64"
							value="0" type="hidden"> <input id="Num_896"
							onclick="return SubChkBox(this,4)" name="Num_896" value="马"
						...
						<td class="ball_ff"><font id="bl_902">3.5</font>
						</td>
						<td class="ball_ff"><input id="sxsx610" name="sxsx610"
							value="0" type="hidden"> <input id="Num_902"
							onclick="return SubChkBox(this,10)" name="Num_902" value="羊"
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_897">4.2</font>
						</td>
						<td class="ball_ff"><input id="sxsx65" name="sxsx65"
							value="0" type="hidden"> <input id="Num_897"
							onclick="return SubChkBox(this,5)" name="Num_897" value="猴"
						...
						<td class="ball_ff"><font id="bl_903">4.2</font>
						</td>
						<td class="ball_ff"><input id="sxsx611" name="sxsx611"
							value="0" type="hidden"> <input id="Num_903"
							onclick="return SubChkBox(this,11)" name="Num_903" value="鸡"
					...
					<tr>
						...
						<td class="ball_ff"><font id="bl_898">4.2</font>
						</td>
						<td class="ball_ff"><input id="sxsx66" name="sxsx66"
							value="0" type="hidden"> <input id="Num_898"
							onclick="return SubChkBox(this,6)" name="Num_898" value="狗"
						...
						<td class="ball_ff"><font id="bl_904">4.2</font>
						</td>
						<td class="ball_ff"><input id="sxsx612" name="sxsx612"
							value="0" type="hidden"> <input id="Num_904"
							onclick="return SubChkBox(this,12)" name="Num_904" value="猪"
