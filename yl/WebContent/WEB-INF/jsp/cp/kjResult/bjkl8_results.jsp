							...
							<div class="pure-g">
								...
								<div class="pure-u-6-24">
									<div class="ui-item-son" style="margin: 0px;padding:0px;">
										<c:choose>
											<c:when test="${fn:contains(blueSet, item.xy28Kjjg)}">
												<span class="ball ball-blue">${item.xy28Kjjg}</span>
											</c:when>
											<c:when test="${fn:contains(graySet, item.xy28Kjjg)}">
												<span class="ball ball-gray">${item.xy28Kjjg}</span>
											</c:when>
											<c:when test="${fn:contains(greenSet, item.xy28Kjjg)}">
												<span class="ball ball-green">${item.xy28Kjjg}</span>
											</c:when>
											<c:when test="${fn:contains(redSet, item.xy28Kjjg)}">
