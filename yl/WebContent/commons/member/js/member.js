...
function selectFromFlat(){
	...
	if(selectFromFlat.val()=="account"){
		...
		selectToFlat.append('<option value="jbb">188体育</option>'); 
...
{
    var wPoints = $("#form1 input[id='wPoints']");
...
function agentApplayCheck(){
	...
	$.ajax( {
		url : rootPath+"/agent/insertApply",
		type : "POST",
...
function gotoPay2(value){
	var url = value;
	$("#payifram").attr("src", url);
}
